...
8.	In “4. Set evaluation behavior” click new evaluation group” and give it a name.
9.	In “5. Configure notifications” select your MQTT contact point.
10.	Click “Save”, you can monitor the MQTT broker for messages using MQTT explorer.
